                    ...
                    <div class="col-md-12">
                        <div class="card" style="min-height: 485px">
                            <div class="card-header card-header-text d-flex justify-content-start align-items-center">
                                ...
                                <button class="btn btn-primary" data-toggle="modal" data-target="#add-tenant-modal">Add
                                    &#43;</button>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class='align-middle'>
                                                <button class="btn btn-small btn-link"
                                                    onclick="viewMember($(this).attr('data-id'))"
                                                    data-id="<?=$user['id']?>">View</button>
                                                <button class="btn btn-small btn-link"
                                                    onclick="updateMember($(this).attr('data-id'))"
...
?>
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-12">
                                    <label>Address</label>
                                    <textarea rows="2" class="form-control" type="text" name="address"
                                        required></textarea>
                ...
                <div class="modal-content" style="max-width:600px">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-12">
                                <label>Address</label>
                                <textarea rows="2" class="form-control" type="text" name="address-view"
                                    readonly></textarea>
                                <small id='address-error' class='text-danger'></small>
                            </div>
                        </div>
                    ...
                    <div class="modal-content" style="max-width:600px">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-5">
                                    <label>First Name</label>
                                    <input class="form-control" type="text" name="first_name" id="first_name-update"
                                        required>
                                    <small id='first_name-error-update' class='text-danger'></small>
                                </div>
                                <div class="col-sm-5">
                                    <label>Last Name</label>
                                    <input class="form-control" type="text" name="last_name" id="last_name-update"
                                        required>
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input class="form-control" type="text" name="middle_initial"
                                        id="middle_initial-update" required>
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-12">
                                    ...
                                    <div class="d-flex" style='gap: 20px'>
                                        <input type="text" class="form-control" name='username' id='username-update'
                                            readonly />
                                        <button type='button' class="btn btn-sm btn-primary"
                                            id='generate-username-btn'>Generate
                                            Username</button>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-12">
                                    <label>Room</label>
                                    <select class="form-control" placeholder="Enter Room" name="room_name"
                                        id="room_id-update" required>
                                        <?php
foreach ($rooms as $room) {
    ?>
                                        <option value="<?=$room['id']?>"><?=$room['room_name']?></option>
...
?>
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <label>Birthdate</label>
                                    <input class="form-control" type="date" name="birthdate" id="birthdate-update"
                                        required>
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control" type="email" name="email_address"
                                        id="email_address-update" required>
                                    <small id='email_address-error-update' class='text-danger'></small>
                                </div>
                                <div class="col-sm-6">
                                    <label>Contact Number</label>
                                    <input class="form-control" type="text" name="contact_number"
                                        id="contact_number-update" required />
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-12">
                                    <label>Address</label>
                                    <textarea rows="2" class="form-control" type="text" name="address"
                                        id="address-update" required></textarea>
                        ...
                        <div class="modal-footer">
                            <button type="button" id="move-out-btn" class="btn btn-danger">Move Out</button>
        ...
        $(document).ready(function() {
            ...
            $('#move-out-btn').click(function() {
                const id = $('#id-update').val();
                $('#move-out-btn').attr('disabled', 'disabled')
                ...
                $.post("./../functions/disable_tenant.php", {
                    ...
                    if (status === 200) {
                        alert('Tenant has been moved out.');
                        window.location.reload();
                    } else {
                        $('#move-out-btn').attr('disabled', '')
                    }
                });
            });
