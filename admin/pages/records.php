                ...
                <div class="row ">
                    <div class="col-sm-12">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link <?= $record === 'payment-ledger' ? "active" : ""?>"
                                    href="./records.php">Payment
                                    Ledger</a>
                            </li>
                            <li class="nav-item">
        ...
        $(document).ready(function() {
            ...
            $('.print-btn').on('click', function({
                ...
                const defaultHeaders = {
                    'payment-ledger': ['Name', 'Payment Reference ID', 'Amount', 'Date', 'Year',
                        'Remarks'
                    ],
                    'tenant-room-activity': ['Name', 'Previous Room', 'New Room', 'Move Date',
                        'Year', 'Remarks'
                    ],
