...
$payments = [];
$sql = "SELECT bp.bill_id, bp.payment_id, p.*, b.reference_id AS bill_reference_id, r.room_name
...
<body>
    ...
    <div class="wrapper">
                    ...
                    <div class="row ">
                        <div class="card" style="min-height: 485px;">
                            <div class="card-header card-header-text d-flex justify-content-start align-items-center">
                                ...
                                <button class="btn btn-success" data-toggle="modal" data-target="#add-payment-modal">Add
                                    &#43;</button>
                                ...
                                <table class="table table-hover" id='payments-table'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle"><?=date('M d, Y', strtotime($row['date_added']))?>
                                            </td>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between">
                                        ...
                                        <button type="button" class="btn btn-primary"
                                            id="search-bill-btn">Search</button>
                                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-12">
                                ...
                                <textarea class="form-control" id="remarks-view" rows="4" style="resize: none"
                                    readonly></textarea>
                            </div>
                        </div>
                    </div>
        ...
        function getPaymentDetails(el = null, val, isId = false) {
        ...
        $(document).ready(function() {
            ...
            if (params.has('pid')) {
                ...
                getPaymentDetails(null, id, true);
            }

            if (params.has('bill_id')) {
                $.get('./../functions/get_bill_details.php?bill_id=' + params.get('bill_id'), function(res) {
                    console.log(res);
                })
            }
            ...
            $('#search-bill-btn').click(function() {
                ...
                $.get("./../functions/get_bill_details.php?reference_id=" + reference_id, function(
                    resp) {
