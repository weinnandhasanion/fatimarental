                ...
                ?></h3>
                            ...
                            <div class="card-footer">
                                <div class="stats">
                                    ...
                                    <a href="./tenants.php">See detailed
                                        report</a>
                                </div>
                            </div>
                        </div>
                  ...
                  ?>
                            ...
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">local_offer</i> <a href="./reservations.php">Monthly
                                        Reservations</a>
                                </div>
                            </div>
                        </div>
                  ...
                  ?>
                            ...
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">date_range</i> <a href="./reports.php">Total Payments</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">update</i> <a href="./rooms.php"> Just Updated </a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 col-md-12">
                        <div class="card" style="min-height: 485px">
                            <div class="card-header card-header-text">
                                <h4 class="card-title">New tenants as of
                                    <?= date("F d, Y", strtotime(date(DATE_ISO8601)))?>
                                </h4>
                                <p class="category">
                                    <?php 
...
foreach ($users as $user) {
    ?>
                                        <tr>
                                            <td><?=$user['id']?></td>
                                            <td><?=$user['first_name'] . " " . $user['middle_initial'] . " " . $user['last_name']?>
                                            </td>
