<?php 
$sql = "SELECT tb.bill_id, b.*, r.room_name FROM tenant_bills AS tb
...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>₱<?= $bill['total'] ?>.00</td>
      <td><button class="btn btn-link" data-id="<?=$bill['id']?>" onclick="window.open('./../shared/bill_details.php?id=' + this.getAttribute('data-id'))">View</button></td>
    </tr>
    <?php endforeach ?>
  </tbody>
</table>